...
namespace Симулятор_жизни
{
    public partial class Form1 : Form
    {
        ...
        private bool ValidateMousePosition(int x, int y)//Это валидатор
        { 
            return x >=0 && y >=0 && x< cols && y< rows;//Описан способ что бы не возникала ошибка если мы уйдем за поле
        }
    }
}
